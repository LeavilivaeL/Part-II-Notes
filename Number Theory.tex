...
\end{corollary}
\begin{proof}
$p \equiv \begin{cases} +1 & p\equiv 1 \mod 4 \\ -1 & p\equiv -1 \mod 4\end{cases} \iff \frac{p-1}{2} \equiv \begin{cases} 0 & \mod 2 \\ 1 & \mod 2\end{cases}$, and hence $(-1)^{\frac{p-1}{2}} \equiv \begin{cases} +1 & p\equiv 1 \mod 4\\ -1 &p\equiv 3 \mod 4\end{cases}$, and so by Euler's criterion, $\legendre{-1}{p} = (-1)^{\frac{p-1}{2}}$
\end{proof}
...
\end{lemma}
\begin{proof}
By the above and observe that $\mu = |\{n \leq j\leq \frac{p-1}{2} : \epsilon_j = -n \}|$, and hence $(-m)^\mu = \Pi_{j=n}^{\frac{p-1}{2}} \epsilon_j$.
\end{proof}
\end{document}
